...
export default {
  ...
  'Externally managed': 'Harici olarak yönetiliyor',
  'Position {0}': 'Sıra {0}',
  'Add routine to the rotation': 'Rotasyona rutin ekle',
  'Add to the rotation': 'Rotasyona ekle',
  'Build a rotation instead': 'Bunun yerine bir rotasyon oluştur',
